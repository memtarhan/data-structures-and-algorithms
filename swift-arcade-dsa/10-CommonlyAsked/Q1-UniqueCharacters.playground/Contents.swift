...
func isUniqueWithDictionary(_ text: String) -> Bool {
...
isUniqueWithDictionary("ab")
isUniqueWithDictionary("aa")
isUniqueWithDictionary("abcdefghijklmnopqrstuvwxyz")

func isUniqueWithSet(_ text: String) -> Bool {
    var set = Set(text)
    return set.count == text.count
}

isUniqueWithSet("ab")
isUniqueWithSet("aa")
isUniqueWithSet("abcdefghijklmnopqrstuvwxyz")
